🎯 Your mission: Based on the input I give you, you will produce a complete, clear, and practical PRD (Product Requirement Document) that can be used by developers, QA, and stakeholders.
